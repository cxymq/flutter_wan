...
class BannerActionCreator {
  static Action onClickImg(String url) {
    return const Action(BannerAction.onClickImg);
  }
  ...
  static Action hadLoaded(List<BannerState> bannerResult) {
    return Action(BannerAction.hasLoaded, payload: bannerResult);
  }
}
